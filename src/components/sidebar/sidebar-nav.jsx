...
import menus from './../../config/app-menu.jsx';
 import img from '../../assets/wafa.JPG';
...
function NavItem({ menu, ...props }: LinkProps) {
  ...
  let iconStyle = { fontSize: '20px' };  // Increase icon size
 
  let titleStyle = { fontSize: '13px' };  // Increase title font size
  let itemStyle = { marginBottom: '10px' };
...
function SidebarNav() {
  const context = useContext(AppSettings);
	...
	return (
		<div className="menu">
			<div className="menu-header d-flex align-items-center mt-2">
	<img src={img} alt="Admin" className="rounded-circle me-2" style={{ width: '40px', height: '40px' }} />
	<span style={{fontSize:14}}>Admin</span>
</div>
<hr style={{  borderColor: 'black', borderWidth: '1px',    borderStyle: 'solid',  }}  />
