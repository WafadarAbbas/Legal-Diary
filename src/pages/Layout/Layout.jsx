...
import CreateUser from './CreateDemo';
import ApiCall from '../../Apicall/ApiCall';
import { useNavigate } from 'react-router-dom';
import _ from 'lodash';  
import 'bootstrap-icons/font/bootstrap-icons.css';  
import EditUser from './EditDemo';
    ...
    return (
        <div>
            ...
            <div className="bg-white p-3 rounded-3 border">
                ...
                <TestPanel>
                    <TestPanelHeader>Demo</TestPanelHeader>
                    <TestPanelBody>
            ...
            <CreateUser open={createRef} close={refClose}  />
            <EditUser   open={editRef} close={editClose} />
            <Footer />
        </div>
    );
};
