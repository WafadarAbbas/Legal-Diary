...
const EditRegistration = (props) => {
    ...
    //   give this RegistrationId to Api to get initial values of selected  data
    useEffect(() => {
        if (RegistrationId) {
              ...
              <form onSubmit={formik.handleSubmit}>
                <ul className="nav nav-pills" id="myTab" role="tablist">
                  <li className="nav-item" role="presentation">
                    <button
                      ...
                      id="edit-case-registration-tab"
                      data-bs-toggle="tab"
                      data-bs-target="#edit-case-registration"
                      type="button"
                      role="tab"
                      aria-controls="edit-case-registration"
                      aria-selected="true"
                      style={{ fontSize: 14 }}
                    >
                      Case Registration
                  ...
                  <li className="nav-item" role="presentation">
                    <button
                      className="nav-link"
                      id="edit-case-bench-tab"
                      data-bs-toggle="tab"
                      data-bs-target="#edit-case-bench"
                      type="button"
                      role="tab"
                      aria-controls="edit-case-bench"
                      aria-selected="false"
                      style={{ fontSize: 14 }}
                    >
                      Case Bench
                  ...
                  <li className="nav-item" role="presentation">
                    <button
                      className="nav-link"
                      id="edit-case-lawyer-tab"
                      data-bs-toggle="tab"
                      data-bs-target="#edit-case-lawyer"
                      type="button"
                      role="tab"
                      aria-controls="edit-case-lawyer"
                      aria-selected="false"
                      style={{ fontSize: 14 }}
                    >
                      Case Lawyer
                ...
                <div className="tab-content mt-3" id="myTabContent">
                  <div
                    ...
                    id="edit-case-registration"
                    role="tabpanel"
                    aria-labelledby="edit-case-registration-tab"
                  >
                    <div className="row ">
  ...
  id="edit-case-bench"
  role="tabpanel"
  aria-labelledby="edit-case-bench-tab"
>
...
<div
  ...
  id="edit-case-lawyer"
  role="tabpanel"
  aria-labelledby="edit-case-lawyer-tab"
>
  <div className="row mb-3">
    <div className="col-3 mb-3">
