...
const EditProceding = (props) => {
  const { ProcedingId } = props;

  console.log(ProcedingId);
  ...
  return (
    <div>
      <button
        ...
        data-bs-target="#EditProcedingModal"
        ref={props.open}
      >
        Launch edit modal
      </button>
      ...
      <div
        ...
        id="EditProcedingModal"
        tabIndex="-1"
        aria-labelledby="EditProcedingModalLabel"
        ...
        <div className="modal-dialog modal-xl">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="EditProcedingModalLabel">
                Edit Proceding
              </h5>
              <button
                type="button"
                ...
                <div className="row mt-3">
                  ...
                  <div className="col-2 mt-3 ">
                    ...
                    <input
                      ...
                      onChange={formik.handleChange}
                      onBlur={formik.handleBlur}
                      checked={formik.values.caseTransfer} // Updated to match the correct Formik value
                      style={{ marginLeft: 10 }}
                    />
                  </div>
