const Menu = [
  { path: 'dashboard', icon: 'fa fa-sitemap', title: 'Dashboard',
    ...
    { path: '/admin', icon: 'fa fa-user', title: 'Super Admin', 
    children: [
      { path: '/admin/user', title: 'User', icon: 'fa fa-user', },
    ]
  },
  { path: '/GenericType', icon: 'fa fa-scroll', title: 'Generic Type', 
    children: [
      { path: '/GenericType/CaseType', title: 'Case Type', icon: 'fa fa-boxes', },
      { path: '/GenericType/LitigantType', title: 'Litigant Type', icon: 'fa fa-user-friends', },
    ]
  },
  { path: '/CourtPanel', icon: 'fa fa-user-graduate', title: 'Court Panel', 
    children: [
      { path: '/CountPanel/Bench', title: 'Bench', icon: 'fa fa-layer-group', },
      { path: '/CountPanel/Court', title: 'Court', icon: 'fa fa-gavel', },
  ...
  { path: '/Testing', icon: 'fa fa-gear', title: 'Testing', 
    children: [
      ...
      { path: '/Testing/Layout', title: 'Layout', icon: 'fa fa-gear', },
    ]
  },
